    ...
    ko.components.register("my-header", {
        ...
        template: 
            `<div class="my-header bolt-header-with-commandbar bolt-header-with-back-button bolt-header flex-row flex-noshrink flex-start bolt-header-no-spacing-defined">
                <button aria-label="Expand all" title="Expand all" class="my-header__button my-header__button--icon icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                ...
                <button aria-label="Collapse all" title="Collapse all" class="my-header__button my-header__button--icon icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                ...
                <button class="my-header__button my-header__button--icon my-header__button--toggle icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                ...
                <div class="bolt-header-content-area flex-row flex-grow flex-self-stretch">
                    ...
                    <div class="flex-self-start bolt-header-commandbar bolt-button-group flex-row" role="menubar">
                        <div class="flex-self-start bolt-header-commandbar-button-group flex-row flex-center flex-grow scroll-hidden rhythm-horizontal-8">
                            <button aria-label="Edit the selected work item" title="Edit the selected work item" class="my-header__button my-header__button--icon my-header__button--for-item icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-label="Focus the selected work item" title="Focus the selected work item" class="my-header__button my-header__button--icon my-header__button--for-item icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-label="Close the selected work item" title="Close the selected work item" class="my-header__button my-header__button--icon my-header__button--for-item icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-label="Refresh data" title="Refresh data" class="my-header__button my-header__button--icon icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-label="Zoom in" title="Zoom in" class="my-header__button my-header__button--icon icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-label="Zoom out" title="Zoom out" class="my-header__button my-header__button--icon icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-label="Reset zoom" title="Reset zoom" class="my-header__button my-header__button--icon icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-label="Move left" title="Move left" class="my-header__button my-header__button--icon icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-label="Move right" title="Move right" class="my-header__button my-header__button--icon icon-only bolt-button bolt-icon-button enabled subtle icon-only bolt-focus-treatment" role="button" tabindex="0" type="button"
                            ...
                            <button aria-roledescription="button" class="bolt-header-command-item-button bolt-button bolt-icon-button enabled bolt-focus-treatment" role="menuitem" tabindex="0" type="button"
